...
[![Maven Central Version](https://img.shields.io/maven-central/v/com.dynatrace.dynahist/dynahist)](https://central.sonatype.com/artifact/com.dynatrace.dynahist/dynahist)
...
![CodeQL](https://github.com/dynatrace-oss/dynahist/actions/workflows/codeql-analysis.yml/badge.svg)
...
* `ExponentialHistogramLargeInclusiveLayout`: A layout that is compatible with [OpenTelemetry](https://opentelemetry.io/) exponential histograms (see [specification](https://github.com/open-telemetry/opentelemetry-specification/blob/45f39f62686c3132db35928a2a45aa84140aaae2/specification/metrics/datamodel.md#exponentialhistogram)).
* `ExponentialHistogramSmallInclusiveLayout`: Similar to `ExponentialHistogramLargeInclusiveLayout`, but smaller instead of larger bin boundaries are inclusive.
