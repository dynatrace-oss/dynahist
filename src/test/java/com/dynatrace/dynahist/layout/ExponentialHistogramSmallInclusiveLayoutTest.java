...
import static com.dynatrace.dynahist.layout.ExponentialHistogramSmallInclusiveLayout.MAX_SCALE;
import static com.dynatrace.dynahist.layout.ExponentialHistogramSmallInclusiveLayout.getBoundaryConstant;
...
class ExponentialHistogramSmallInclusiveLayoutTest {

  @Test
  void testConsistency() {
    for (int scale = 0; scale <= MAX_SCALE; ++scale) {
      Layout layout = ExponentialHistogramSmallInclusiveLayout.create(scale);
  ...
  @Test
  void testMapping0() {
    Layout layout = ExponentialHistogramSmallInclusiveLayout.create(0);
  ...
  @Test
  void testMapping1() {
    Layout layout = ExponentialHistogramSmallInclusiveLayout.create(1);
  ...
  @Test
  void testMapping2() {
    Layout layout = ExponentialHistogramSmallInclusiveLayout.create(2);
  ...
  void testLowerBoundApproximation() {
    for (int scale = 0; scale <= MAX_SCALE; ++scale) {
      ExponentialHistogramSmallInclusiveLayout layout =
          ExponentialHistogramSmallInclusiveLayout.create(scale);
  ...
  void testBoundaryConsistency() {
    ...
    for (int scale = 0; scale <= MAX_SCALE; ++scale) {
      ...
      int len = 1 << scale;
      long[] boundaries = ExponentialHistogramSmallInclusiveLayout.calculateBoundaries(scale);
  ...
  @Test
  void testHashCode() {
    Layout layout = ExponentialHistogramSmallInclusiveLayout.create(3);
  ...
  void testToString() {
    Layout layout = ExponentialHistogramSmallInclusiveLayout.create(3);
    assertEquals("ExponentialHistogramSmallInclusiveLayout [scale=3]", layout.toString());
  }

  @Test
  void testEquals() {
    Layout layout3a = ExponentialHistogramSmallInclusiveLayout.create(3);
    Layout layout3b = ExponentialHistogramSmallInclusiveLayout.create(3);
    Layout layout3c = new ExponentialHistogramSmallInclusiveLayout(3);
    Layout layout4 = ExponentialHistogramSmallInclusiveLayout.create(4);
  ...
  void testCreate() {
    assertThrows(
        IllegalArgumentException.class, () -> ExponentialHistogramSmallInclusiveLayout.create(-1));
    assertThrows(
        IllegalArgumentException.class,
        () -> ExponentialHistogramSmallInclusiveLayout.create(MAX_SCALE + 1));
  }
