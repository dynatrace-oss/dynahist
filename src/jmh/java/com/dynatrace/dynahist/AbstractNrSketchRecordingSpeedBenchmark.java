...
public abstract class AbstractNrSketchRecordingSpeedBenchmark
    extends AbstractRecordingSpeedBenchmark<NrSketch> {
  ...
  @Override
  protected void consume(NrSketch histogram, Blackhole blackhole) {
